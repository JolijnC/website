...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/website/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/website/outreach/";
          },
        },{id: "nav-cv",
          title: "cv",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/website/teaching_supervising/";
          },
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A.%63%6F%74%74%61%61%72%31@%74%75%65.%6E%6C", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jolijn-cottaar-9418931b3", "_blank");
        },
      },{
      id: 'light-theme',
